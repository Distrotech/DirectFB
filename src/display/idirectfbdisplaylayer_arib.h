...
#ifndef __IDIRECTFBDISPLAYLAYER_ARIB_H__
#define __IDIRECTFBDISPLAYLAYER_ARIB_H__
...
typedef struct {
	IDirectFBDisplayLayer_data	   parent;
} IDirectFBARIBDisplayLayer_data;

/*
 * initializes interface struct and private data
 */
DFBResult
IDirectFBARIBDisplayLayer_Construct(
